...
/*   Updated: 2023/05/22 11:48:41 by lkavalia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const & form)
{
	if (form.execute(*this) == true)
		std::cout << GREEN << this->getName() << BLANK << " executed " << form.getName() << std::endl; 
	else
		std::cerr << RED << form.getName() << " | " << "execute Form has failed!" << std::endl;
}
